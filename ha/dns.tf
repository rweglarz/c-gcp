...
resource "google_dns_record_set" "this" {
  for_each = {
    ha-srv0   = google_compute_instance.srv["srv0"].network_interface.0.access_config.0.nat_ip,
    ha-srv1   = google_compute_instance.srv["srv1"].network_interface.0.access_config.0.nat_ip,
